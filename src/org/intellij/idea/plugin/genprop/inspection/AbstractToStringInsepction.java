...
/**
 * Base class for GenerateToString Inspection support.
 *
 * @author Claus Ibsen
 * @since 2.13
 */
public abstract class AbstractToStringInsepction extends LocalInspectionTool {
    ...
    private static Logger log = Logger.getLogger(AbstractToStringInsepction.class);
    ...
    protected List filterFields(PsiField[] fields, PsiAdapter psi) {
        ...
        for (int i = 0; i < fields.length; i++) {
            ...
            FieldElement fe = ElementFactory.newFieldElement(field, GeneratePropertyNameContext.getElementFactory(), psi);
